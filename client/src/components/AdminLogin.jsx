  ...
  setVisible(!visible);
    ...
    return (
        <div className="wrapper m-5" >
              ...
              {alert=== "failed" ? <div  className={ visible?"alert alert-danger alert-dismissible show":"alert alert-danger alert-dismissible fade" } role="alert" >
              <a href="#" class="close" data-dismiss="alert" aria-label="close" onClick={onAlert}>&times;</a>
